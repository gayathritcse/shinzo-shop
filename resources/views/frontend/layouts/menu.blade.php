...
<nav class="navbar navbar-expand-lg main_menu">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="{{ asset(config('settings.logo')) }}" alt="Shinzo Shop" class="img-fluid">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="menu_icon d-flex flex-wrap">
                ...
                <li>
                    <a class="cart_icon"><i class="fas fa-shopping-cart"></i> <span
                        ...
                        @else
                            ...
                            <li>
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    this.closest('form').submit();"><i ></i>Log In</a>
                                </form>
                            </li>
                        @endif
                </li>
