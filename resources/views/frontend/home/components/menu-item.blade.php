        ...
        <div class="row wow fadeInUp" data-wow-duration="1s">
            <div class="col-md-8 col-lg-7 col-xl-6 m-auto text-center">
                <div class="fp__section_heading mb_45">
                    ...
                    <p>Indulge in our signature dishes, crafted with the freshest ingredients with flavor. 
                    From mouth-watering appetizers to decadent desserts, each bite promises an unforgettable culinary experience.</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="fp__menu_item">
                        ...
                        <div class="fp__menu_item_text">
                            ...
                            <ul class="d-flex flex-wrap justify-content-center">
                                <li><a href="javascript:;" onclick="loadProductModal('{{ $product->id }}')"><i class="fas fa-shopping-cart"></i></a></li>
