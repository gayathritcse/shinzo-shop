        ...
        $(document).ready(function(){
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(index, message){
                            ...
                            let html = `
                            <div class="chat-item ${message.sender_id == userId ? "chat-right" : "chat-left"} " style=""><div class="chat-details"><div class="chat-text">${message.message}</div></div></div>
                            `
            ...
            $('#chat-form').on('submit', function(e){
                ...
                $.ajax({
                    ...
                    let html = `
                            <div class="chat-item chat-right" style=""><div class="chat-text">${message}</div><div class="chat-time ${msgId}">sending...</div></div></div>
                            `
